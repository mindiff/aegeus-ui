...
You should now be able to access the WebUI at: http://127.0.0.1:8082/portal
...
```
curl --request POST --data @README.md http://127.0.0.1:8081/aegeus/add?addr=AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX\&path=README.md

{
    "owner":"AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX",
    "path":"README.md",
    "cid":"QmeuV2mgXJ82qv6zZ317beWDEZxi76kaorcc6o7pU2NB2z",
    "encrypted":true
}
```
...
```
curl http://127.0.0.1:8080/ipfs/QmeuV2mgXJ82qv6zZ317beWDEZxi76kaorcc6o7pU2NB2z

AEG-Version: 1.0
Path: README.md
Owner: AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX
Token: BNgQ9pAKrQLPpFgF0p3ta9TH/dYRXMEVhoE7NcyJPGzOKZzu1SAlfwK5zUXbwKn3sg7FhzIayeEyYjjyOo4hUIWH/zRg
AEG_HEADER_END
AAAADPpVyBzwmz0RkOVKQpnsBd3r+LsidqO6kb/a.....
```
...
```
curl http://127.0.0.1:8081/aegeus/dellocal?addr=AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX\&path=README.md
curl http://127.0.0.1:8081/aegeus/findlocal?addr=AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX
...
```
curl http://127.0.0.1:8081/aegeus/get?addr=AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX\&path=README.md\&cid=QmeuV2mgXJ82qv6zZ317beWDEZxi76kaorcc6o7pU2NB2z
...
```
curl http://127.0.0.1:8081/aegeus/getlocal?addr=AJG36ywiYJnxJLdRDw8nzHUqKbAujmjvpX\&path=README.md

## Aegeus User Interface ...
```

This concludes this little walk through the system using JSON-RPC.
...
For this to work your `aegeus.conf` should look something like this
